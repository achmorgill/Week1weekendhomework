...
class TestPetShop < Minitest::Test
  ...
  def test_add_or_remove_cash_add
    new_total_cash = add_or_remove_cash(@pet_shop,10)
    # cash = total_cash(@pet_shop)
    # new_total_cash = sales + cash
    assert_equal(1010, new_total_cash)
  end

  def test_add_or_remove_cash_remove
    new_total_cash = add_or_remove_cash(@pet_shop,-10)
    # cash = total_cash(@pet_shop)
    assert_equal(990, new_total_cash)
  end
  ...
  def test_increase_pets_sold_hash_updated
